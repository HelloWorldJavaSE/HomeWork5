    ...
    */
    ...
    public static class Person {
        ...
        void takeDamage(int damage) throws Exception {
            ...
            int musor = health - (damage - protection);
            if (musor>0){
                health = musor;
            }
            else if (health==0){
    ...
    public static class Mage extends Person{
       ...
       @Override
        public String announce(){
            return "Mage"+ name +"имеет характеристики:"+ health +"здоровья и"+ protection+ "защиты";
       }
      ...
      @Override
       void takeDamage(int damage) throws Exception {
            int kal = health - (damage - protection - health % 10);
            if(kal <=0){
